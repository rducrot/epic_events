...
class ClientAdmin(admin.ModelAdmin):
    list_display = ('last_name', 'first_name', 'client_status', 'email', 'company_name', 'sales_contact')
...
class ContractAdmin(admin.ModelAdmin):
    list_display = ('pk', 'client', 'contract_status', 'amount', 'payment_due', 'sales_contact')
    list_filter = ('sales_contact',)
    search_fields = ('client', 'sales_contact')


class EventAdmin(admin.ModelAdmin):
    list_display = ('pk', 'contract', 'event_status', 'attendee', 'event_date', 'support_contact')
